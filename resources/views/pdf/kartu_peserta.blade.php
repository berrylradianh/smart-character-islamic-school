            ...
            <div class="details">
                ...
                <table>
                    <tr>
                        <td>No Peserta</td>
                        <td>:</td>
                        <td>{{ $registration->no_peserta ?? 'Belum ditentukan' }}</td>
                    </tr>
                    <tr>
                        <td>Asal Sekolah</td>
                        <td>:</td>
                        <td>{{ $user->sd_mi_asal ?? 'Tidak diisi' }}</td>
                    </tr>
                    <tr>
                        <td>Jenjang</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Jadwal Tes</td>
                        <td>:</td>
                        <td>{{ $registration->jadwal_tes ? \Carbon\Carbon::parse($registration->jadwal_tes)->format('d M Y, H:i') : 'Belum ditentukan' }}</td>
                    </tr>
                    <tr>
                        <td>Lokasi</td>
                        <td>:</td>
                        <td>{{ $registration->schoolLocation ? $registration->schoolLocation->nama_lokasi . ', ' . $registration->schoolLocation->alamat : 'Belum ditentukan' }}</td>
                    </tr>
                    <tr>
                        <td>Gedung</td>
                        <td>:</td>
                        <td>{{ $registration->gedung ? $registration->gedung->nama_gedung : 'Belum ditentukan' }}</td>
                    </tr>
                    <tr>
                        <td>Ruang</td>
                        <td>:</td>
                        <td>{{ $registration->ruang ? $registration->ruang->nama_ruang : 'Belum ditentukan' }}</td>
                    </tr>
                </table>
            </div>
        </div>
        <div class="footer">
            © SCIS, 2025. Silakan bawa kartu ini pada hari tes.
        </div>
    </div>
</body>
</html>
