<section class="blog__area pt-60 p-relative">
        ...
        <div class="row">
            <div class="col-xxl-12">
                <div class="section__title-wrapper mb-60 text-center">
                    <h2 class="section__title section__title-44">Berita & Kegiatan</h2>
                </div>
            </div>
        </div>
        <div class="row">
                ...
                <div class="blog__item mb-30 white-bg transition-3 mb-30">
                    <div class="blog__thumb w-img fix">
                        <a href="blog-details.html">
                            <img src="assets/img/blog/tahfidz-super-camp.png" alt="">
                        </a>
                    </div>
                    <div class="blog__content">
                        <h3 class="blog__title">
                            <a href="blog-details.html">Tahfidz Super Camp Nasional Ke-7</a>
                        </h3>
                        <p class="blog__desc">Kegiatan tahfidz super camp nasional ke-7 telah sukses digelar di Bandung dengan peserta dari berbagai daerah.</p>
