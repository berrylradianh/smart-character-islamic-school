                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="agenda-card">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" placeholder="Type your title here...." id="title_0" name="agendas[0][title]" value="{{ old('agendas.0.title') }}">
                                                    @error('agendas.0.title') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="description_0" class="col-sm-2 col-form-label">Description</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" placeholder="Type your description here...." id="description_0" name="agendas[0][description]" value="{{ old('agendas.0.description') }}">
                                                    @error('agendas.0.description') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="date_0" class="col-sm-2 col-form-label">Date</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="date" id="date_0" name="agendas[0][date]" value="{{ old('agendas.0.date') }}">
                                                    @error('agendas.0.date') <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="m-b-30">
                                                        <input type="file" name="agendas[0][file]" id="image_0" accept="image/*" class="form-control-file image-input">
                                                        ...
                                                        @error('agendas.0.file') <span class="text-danger">{{ $message }}</span> @enderror
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-12">
                        <div class="card m-b-30">
                            <div class="card-body">
                                ...
                                <form action="{{ route('dashboard.agenda.destroy', $item->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <div class="agenda-card">
                                        <div class="form-group row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="agenda-card">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" placeholder="Type your title here...." id="title_${agendaCount}" name="agendas[${agendaCount}][title]">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="description_${agendaCount}" class="col-sm-2 col-form-label">Description</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" placeholder="Type your description here...." id="description_${agendaCount}" name="agendas[${agendaCount}][description]">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="date_${agendaCount}" class="col-sm-2 col-form-label">Date</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="date" id="date_${agendaCount}" name="agendas[${agendaCount}][date]">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Image</label>
                                <div class="col-sm-10">
                                    <div class="m-b-30">
                                        <input type="file" name="agendas[${agendaCount}][file]" id="image_${agendaCount}" accept="image/*" class="form-control-file image-input">
                            ...
                            <div class="text-center m-t-15">
                                <button type="button" class="btn btn-danger waves-effect waves-light remove-agenda">Remove</button>
                            </div>
                        </div>
                    </div>
                </div>
